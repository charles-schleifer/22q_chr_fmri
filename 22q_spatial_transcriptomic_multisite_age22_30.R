...
# FILTER AGE:
demo_multisite_bl <- filter(demo_multisite_bl, AGE >= 22 & AGE < 30)
...
view_xifti_surface(plot_rsfa_diff_beta, title="RSFA diff beta (22qDel - HCS; Age 22-30)", cex.title=1.3,zlim=c(-0.7,0.7),colors=pal_red_blue())
view_xifti_volume(plot_rsfa_diff_beta, title="RSFA diff beta (22qDel - HCS; Age 22-30)", cex.title=1.3,zlim=c(-0.7,0.7),colors=pal_red_blue())
...
view_xifti_surface(plot_rsfa_diff_beta_fdr, title="RSFA diff beta FDR corrected (22qDel - HCS; Age 22-30)", cex.title=1.3,zlim=c(-0.7,0.7), colors=pal_red_blue())
view_xifti_volume(plot_rsfa_diff_beta_fdr, title="RSFA diff beta FDR corrected (22qDel - HCS; Age 22-30)", cex.title=1.3,zlim=c(-0.7,0.7), colors=pal_red_blue())
