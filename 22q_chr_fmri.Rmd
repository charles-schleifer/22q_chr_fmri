...
cor_brain_maps <- function(map1, map2, method="pearson", use="complete.obs"){
  cor <- cor(x=as.numeric(map1), y=as.numeric(map2), use=use, method=method)
  return(cor)
}
...
# get top 10% of absolute value correlations for RSFA
rsfa_ahba_abs10 <- get_quantile_genes(df=rsfa_ahba_cor, probs=0.90, alternative="two.sided")
