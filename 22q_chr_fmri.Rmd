...
# plot
pl_gbc_22q_psych <- atlas_xifti_new_vals(xii=xii_Ji_parcel, df=gbc_22q_psych, roi_col="INDEX", val_col="group_beta_FDR")
view_xifti_surface(pl_gbc_22q_psych, title="Global Connectivity: 22qDel PS+ vs PS- (FDR q<0.05)", cex.title=1.3,zlim=c(-0.8,0.8), colors=pal_red_blue())
```
