...
# get main effects of group for each measure
# TODO: add cardiac status to rsfa_wide$df, need new group column for +/- congenital heart Dx, filter for only 22qDel
rsfa_22q_heart <- get_parcel_group_lm(list=rsfa_wide, groups=c("22qDel","CONTROL"),refgroup="CONTROL",roi_key=filter(ji_key,INDEX %in% 1:360))
