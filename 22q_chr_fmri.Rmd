...
napls_sessions <- list.files(napls_dir,pattern="[0-9]_*00")
...
napls_bparc <- lapply(napls_sessions, function(s) read_csv_results(sesh=s,site="NAPLS2",sdir=napls_dir,fname=bparc_name_napls)) %>% do.call(rbind,.)

bparc_all <- rbind(trio_bparc,prisma_bparc,suny_bparc,rome_bparc,iop_bparc,napls_bparc)
