...
# print tables
demo_table_22q_f <- print(demo_table_22q, showAllLevels = F, test=F,quote=F, contDigits=1)
demo_table_n_f <- print(demo_table_napls, showAllLevels = F, test=F,quote=F, contDigits=1)
demo_table_all <- cbind(demo_table_22q_f,demo_table_n_f)
colnames(demo_table_all) <- c("22qDel","Control_22q","CHR","Control_CHR")
