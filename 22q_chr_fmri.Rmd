...
rsfa_chr_lms <- get_parcel_group_lm(list=rsfa_wide, groups=c("CHR","CONTROL-N"), refgroup="CONTROL-N", refsite="UCLAtrio", roi_key=filter(ji_key,INDEX %in% 1:360))
...
gbc_22q_lms <- get_parcel_group_lm(list=gbc_wide, groups=c("22qDel","CONTROL"), refgroup="CONTROL", refsite="NAPLS1", roi_key=filter(ji_key,INDEX %in% 1:360))
