...
run_neurocombat <- function(input, 
  ...
  out_combat <- neuroCombat(dat=input_subcols[,subcols], batch=covardf$Site, mod=model.matrix(~covardf$AGE + covardf$SEX + covardf$percent_udvarsme), parametric=TRUE)
