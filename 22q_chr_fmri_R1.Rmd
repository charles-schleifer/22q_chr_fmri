...
ctrl_22q_gbc_box_R <- ggplot(data=control_22q_gbc_nulls_long_R, aes(y=value, x=variable))+
  ...
  #xlab("Brain Map Comparison")+
  xlab("")+
  ggtitle("Global Connectivity Control22q")
  #theme(legend.position="none")
...
ctrl_22q_netho_box_R <- ggplot(data=control_22q_netho_nulls_long_R, aes(y=value, x=variable))+
  ...
  #xlab("Brain Map Comparison")+
  xlab("")+
  ggtitle("Local Connectivity Control22q")
...
ctrl_22q_rsfa_box_R <- ggplot(data=control_22q_rsfa_nulls_long_R, aes(y=value, x=variable))+
  ...
  #xlab("Brain Map Comparison")+
  xlab("")+
  ggtitle("Brain Signal Variability Control22q")+
  theme(plot.margin = unit(c(0,0,0,0.7),"in"))+
  scale_x_discrete(labels=nmap_match$name)
...
ctrl_n_gbc_box_R <- ggplot(data=control_n_gbc_nulls_long_R, aes(y=value, x=variable))+
  ...
  #xlab("Brain Map Comparison")+
  xlab("")+
  ggtitle("Global Connectivity ControlCHR")+
  theme(legend.position="none")
...
ctrl_n_netho_box_R <- ggplot(data=control_n_netho_nulls_long_R, aes(y=value, x=variable))+
  ...
  #xlab("Brain Map Comparison")+
  xlab("")+
  ggtitle("Local Connectivity ControlCHR")
...
ctrl_n_rsfa_box_R <- ggplot(data=control_n_rsfa_nulls_long_R, aes(y=value, x=variable))+
  ...
  xlab("Brain Map Comparison")+
  #xlab("")+
  ggtitle("Brain Signal Variability ControlCHR")+
  theme(plot.margin = unit(c(0,0,0,0.7),"in"))+
  scale_x_discrete(labels=nmap_match_R$name)+
  theme(legend.position="none")
