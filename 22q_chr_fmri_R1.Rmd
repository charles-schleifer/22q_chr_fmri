...
view_xifti_surface(pl_rsfa_control_22q, title="Control22q Mean BSV", cex.title=1.3, colors="magma")
if(save_outputs==TRUE){
  view_xifti_surface(pl_rsfa_control_22q, colors="magma", fname=file.path(project,"figures/fmri_maps/control22q_bsv.png"),legend_embed=TRUE)
}

pl_rsfa_control_n <- atlas_xifti_new_vals(xii=xii_Ji_parcel, df=control_n_rsfa, roi_col="INDEX", val_col="value")
view_xifti_surface(pl_rsfa_control_n, title="ControlCHR Mean BSV", cex.title=1.3, colors="magma")
if(save_outputs==TRUE){
  view_xifti_surface(pl_rsfa_control_n, colors="magma", fname=file.path(project,"figures/fmri_maps/controlCHR_bsv.png"),legend_embed=TRUE)
}

# LC
pl_netho_control_22q <- atlas_xifti_new_vals(xii=xii_Ji_parcel, df=control_22q_netho, roi_col="INDEX", val_col="value")
view_xifti_surface(pl_netho_control_22q, title="Control22q Mean LC", cex.title=1.3, colors=pal_red_blue())
if(save_outputs==TRUE){
  view_xifti_surface(pl_netho_control_22q, colors=pal_red_blue(), fname=file.path(project,"figures/fmri_maps/control22q_lc.png"),legend_embed=TRUE)
}


pl_netho_control_n <- atlas_xifti_new_vals(xii=xii_Ji_parcel, df=control_n_netho, roi_col="INDEX", val_col="value")
view_xifti_surface(pl_netho_control_n, title="ControlCHR Mean LC", cex.title=1.3, colors=pal_red_blue())
if(save_outputs==TRUE){
  view_xifti_surface(pl_netho_control_n, colors=pal_red_blue(), fname=file.path(project,"figures/fmri_maps/controlCHR_lc.png"),legend_embed=TRUE)
}

# GBC
pl_gbc_control_22q <- atlas_xifti_new_vals(xii=xii_Ji_parcel, df=control_22q_gbc, roi_col="INDEX", val_col="value")
view_xifti_surface(pl_gbc_control_22q, title="Control22q Mean GBC", cex.title=1.3, colors=pal_red_blue())
if(save_outputs==TRUE){
  view_xifti_surface(pl_gbc_control_22q, colors=pal_red_blue(), fname=file.path(project,"figures/fmri_maps/control22q_gbc.png"),legend_embed=TRUE)
}

pl_gbc_control_n <- atlas_xifti_new_vals(xii=xii_Ji_parcel, df=control_n_gbc, roi_col="INDEX", val_col="value")
view_xifti_surface(pl_gbc_control_n, title="ControlNAPLS Mean GBC", cex.title=1.3, colors=pal_red_blue())
if(save_outputs==TRUE){
  view_xifti_surface(pl_gbc_control_n, colors=pal_red_blue(), fname=file.path(project,"figures/fmri_maps/controlCHR_gbc.png"),legend_embed=TRUE)
}
