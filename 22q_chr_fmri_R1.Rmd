...
# write control means
# 22q Control 
control_22q_rsfa_L <- filter(control_22q_rsfa, INDEX <= 180)
if(save_bsmash_outputs==TRUE){
...
control_22q_netho_L <- filter(control_22q_netho, INDEX <= 180)
if(save_bsmash_outputs==TRUE){
...
control_22q_gbc_L <- filter(control_22q_gbc, INDEX <= 180) 
if(save_bsmash_outputs==TRUE){
...
control_22q_rsfa_R <- filter(control_22q_rsfa, INDEX > 180 & INDEX <= 360) 
if(save_bsmash_outputs==TRUE){
...
control_22q_netho_R <- filter(control_22q_netho, INDEX > 180 & INDEX <= 360)
if(save_bsmash_outputs==TRUE){
...
control_22q_gbc_R <- filter(control_22q_gbc, INDEX > 180 & INDEX <= 360) 
if(save_bsmash_outputs==TRUE){
...
control_n_rsfa_L <- filter(control_n_rsfa, INDEX <= 180) 
if(save_bsmash_outputs==TRUE){
...
control_n_netho_L <- filter(control_n_netho, INDEX <= 180) 
if(save_bsmash_outputs==TRUE){
...
control_n_gbc_L <- filter(control_n_gbc, INDEX <= 180) 
if(save_bsmash_outputs==TRUE){
  write.table(control_n_gbc_L, file=file.path(project,"CAB-NP/control_n_gbc_L"), quote=FALSE, col.names = FALSE, row.names = FALSE)
}


control_n_rsfa_R <- filter(control_n_rsfa, INDEX > 180 & INDEX <= 360) 
if(save_bsmash_outputs==TRUE){
...
control_n_netho_R <- filter(control_n_netho, INDEX > 180 & INDEX <= 360)
if(save_bsmash_outputs==TRUE){
...
control_n_gbc_R <- filter(control_n_gbc, INDEX > 180 & INDEX <= 360) 
if(save_bsmash_outputs==TRUE){
